...
import mx.certificatic.practicas.seguridad.ejb.SessionBeanSeguridad;
...
public class SeguridadServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try (PrintWriter out = response.getWriter()) {
			...
			out.println("<html>");
			out.println("<head>");
			out.println("<title>Servlet SeguridadServlet</title>");
			out.println("</head>");
			out.println("<body>");
